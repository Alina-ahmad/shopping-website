...
const Slide: React.FC<propsType> = ({ img, title, mainTitle, price }) => {
  return (
    ...
    <div className="outline-none border-none relative px-[43px]">
      <div className="absolute left-[30px] md:left-[70px] max-w-[250px] sm:max-w-[350px] top-[50%] -translate-y-[50%] space-y-2 lg:space-y-4 bg-[#ffffffa2] sm:bg-transparent p-4 sm:p-0 rounded-lg sm:rounded-none">
        ...
        <div className="bg-[#ff8f9c] text-white text-[14px] md:text-[16px] p-2 px-4 rounded-lg inline-block cursor-pointer hover:bg-blackish">
          Shop Now{" "}
        </div>
      </div>
      <Image
        className="w-[100%] h-[30px] md:h-auto rounded-xl object-cover object-right md:object-left-bottom lg:object-center"
        src={img}
        alt="banner"
        width={2000}
        height={2000}
